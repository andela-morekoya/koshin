...
import { updateWatchedRepoDetails } from '../../actions/repoActions';
...
class RepoDetails extends React.Component {
  ...
  //   this.props.resetComponent(false);
  // }
  ...
  addRepo() {
    ...
    this.props.updateWatchedRepoDetails(content);
    this.props.resetComponent(false);
  }
  ...
  getProductName(e) {
    console.log('therepo details', this.props.repo)
    let name = this.props.repo.name;
    if (e) {
      name = e.target.value;
    }
      ...
      <div className="add-repo-list panel panel-default" style={{ margin: '10px' }}>
        <div className="panel-heading">
          ...
          <div style={{ display: 'inline', float: 'right' }}>
            <input type="button" className="btn btn-primary" name="repo_name" value="Save" onClick={this.addRepo} />
        ...
        <div id={repo.id}
          className={'repodetails panel-body collapse in'} >
...
RepoDetails.propTypes = {
  ...
  updateWatchedRepoDetails: React.PropTypes.func,
